...
from data.ev_img_dataloader.sequence_rnd import SequenceForRandomAccess
...
class SequenceDataset(Dataset):
    def __init__(self,
        ...
        time_flip = np.random.rand() < dataset_config.data_augmentation.random.prob_time_flip

        label_shift = dataset_config.shift.label # dataset_config.model_type != 'frame'
        image_shift = dataset_config.shift.image
        # print('label_shift in random: ', label_shift)
