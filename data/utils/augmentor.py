...
class RandomSpatialAugmentorGenX:
    ...
    def _zoom_out_and_rescale_recursive(cls,
                                        ...
                                        zoom_out_factor: float,
                                        datatype: DataType):
        if datatype in (DataType.IS_PADDED_MASK, DataType.IS_FIRST_SAMPLE, DataType.DRIFT):
            return input_
        ...
        for k, v in data_dict.items():
            ...
            if _hw is not None:
                ...
                if height is None:
                    ...
                    assert height == _height and width == _width, 'height: {}, _height: {}, width: {}, _width:{}'.format(height, _height, width, _width)
