...
def main(config: DictConfig):
    ...
    mode = 'gt'            # ['gt', 'pre']  # GT模式：只可视化标签，不需要权重
    show_mode = 'mixed'       # ['event', 'rgb', 'mixed']
    
    # DSEC数据集路径 - 请根据实际数据修改具体的测试序列
    # 例如：'E:/dataset/freq_1_2/freq_1_1/test/zurich_city_11_a'
    h5_file = 'E:/dataset/freq_1_2/freq_1_1/test/zurich_city_11_a'  # DSEC测试序列路径
    ...
    if mode == 'pre':
        ...
        print('=' * 50)
        print('DSEC GT模式：跳过模型加载，只可视化Ground Truth标签')
        print('=' * 50)
    ...
    if mode == 'pre':
        images_out_put_dir = 'predictions_dsec/images'
        video_out_put_dir = 'predictions_dsec/video'
    elif mode == 'gt':
        images_out_put_dir = 'gt_dsec/images'  # DSEC数据集GT可视化输出
        video_out_put_dir = 'gt_dsec/video'
