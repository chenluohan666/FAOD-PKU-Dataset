...
class RNNFusionDetectorStage(nn.Module):
    ...
    def __init__(self,
        ...
        if resnet_layers == 18:
            self.ev_resnet_initial_layer = th_models.resnet18(pretrained=False).layer1
            self.img_resnet_initial_layer = th_models.resnet18(pretrained=False).layer1
        elif resnet_layers == 34:
            self.ev_resnet_initial_layer = th_models.resnet34(pretrained=False).layer1
            self.img_resnet_initial_layer = th_models.resnet34(pretrained=False).layer1
        elif resnet_layers == 50:
            self.ev_resnet_initial_layer = th_models.resnet50(pretrained=False).layer1
            self.img_resnet_initial_layer = th_models.resnet50(pretrained=False).layer1
        else:
    ...
    def forward_ssm(self, ev_input: th.Tensor,
        ...
        ev_input = self.ev_resnet_initial_layer(ev_input)
        img_input = self.img_resnet_initial_layer(img_input)
...
class RNNDetectorStage(nn.Module):
    ...
    def __init__(self,
        ...
        if resnet_layers == 18:
            resnet = th_models.resnet18(pretrained=False)
        elif resnet_layers == 34:
            resnet = th_models.resnet34(pretrained=False)
        elif resnet_layers == 50:
            resnet = th_models.resnet50(pretrained=False)
        else:
            raise NotImplementedError
        
        if stage_idx == 1:
            self.resnet_layer = resnet.layer2
        elif stage_idx == 2:
            self.resnet_layer = resnet.layer3
        elif stage_idx == 3:
            self.resnet_layer = resnet.layer4
        else:
            raise NotImplementedError
